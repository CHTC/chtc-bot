...
@pytest.mark.parametrize("input, expected, rssCH", [
        (
            { 'title': 'Check-in [59661]:   (By Tim Theisen )',
              'description': '(<span class="ticket"><a href="https://htcondor-wiki.cs.wisc.edu/index.cgi/tktview?tn=7643" class="new" title="Get HTCondor to build on Modern Fedora without warnings">#7643</a></span>) Fix compiler warning where strncpy count depends on source <br>',
